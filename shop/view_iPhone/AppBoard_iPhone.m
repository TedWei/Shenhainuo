...
#import "I0_TestListBoard_iPhone.h"
...
ON_SIGNAL2( BeeUIBoard, signal )
{
	if ( [signal is:BeeUIBoard.CREATE_VIEWS] )
	{
        ...
        bee.ui.router[self.TAB_Personal]= [I0_PersonalListBoard_iPhone class];
        bee.ui.router[self.TAB_TEST]    = [I0_TestListBoard_iPhone class];
...
ON_SIGNAL3( AppTabbar_iPhone, test_button, signal )
{
    [bee.ui.tabbar selectTest];
    [bee.ui.router open:AppBoard_iPhone.TAB_TEST animated:NO];
}
